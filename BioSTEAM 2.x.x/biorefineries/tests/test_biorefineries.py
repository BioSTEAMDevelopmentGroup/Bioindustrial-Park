...
def test_corn():
    ...
    tea = module.corn_tea
    units = UnitGroup('Biorefinery', tea.units)
    assert np.allclose(tea.IRR, 0.37669282499141576, rtol=1e-2)
    ...
    assert np.allclose(tea.sales, 72934913.89320123, rtol=1e-2)
    assert np.allclose(tea.material_cost, 54210719.80237047, rtol=1e-2)
    assert np.allclose(tea.installed_equipment_cost, 89320009.44310677, rtol=1e-2)
    assert np.allclose(tea.utility_cost, 82588205.85860638, rtol=1e-2)
    assert np.allclose(units.get_heating_duty(), 136.94482500718672, rtol=1e-2)
    assert np.allclose(units.get_cooling_duty(), 1205.6429385566744, rtol=1e-2)
    assert np.allclose(units.get_electricity_consumption(), 2.911488025419969, rtol=1e-2)
...
def test_lipidcane():
    ...
    units = UnitGroup('Biorefinery', tea.units)
    assert np.allclose(tea.IRR, 0.20879560711988565, rtol=1e-2)
    assert np.allclose(feedstock.price, 0.03455, rtol=1e-2)
    assert np.allclose(product.price, 0.789, rtol=1e-2)
    assert np.allclose(tea.sales, 108114570.73220268, rtol=1e-2)
    assert np.allclose(tea.material_cost, 58991753.431800194, rtol=1e-2)
    assert np.allclose(tea.installed_equipment_cost, 236629292.52296945, rtol=1e-2)
    assert np.allclose(tea.utility_cost, -33691447.31642461, rtol=1e-2)
    assert np.allclose(units.get_heating_duty(), 252.1274638579776, rtol=1e-2)
    assert np.allclose(units.get_cooling_duty(), 264.2258027625816, rtol=1e-2)
    assert np.allclose(units.get_electricity_consumption(), 15.945648197940056, rtol=1e-2)
    assert np.allclose(units.get_electricity_production(), 124.72245199361572, rtol=1e-2)
    bst.process_tools.default()
...
def test_cornstover():
    ...
    assert np.allclose(product.price, 0.7329350011500639, rtol=1e-2)
    assert np.allclose(tea.sales, 133863631.31604883, rtol=1e-2)
    assert np.allclose(tea.material_cost, 82430522.10975507, rtol=1e-2)
    assert np.allclose(tea.installed_equipment_cost, 215855079.60958537, rtol=1e-2)
    assert np.allclose(tea.utility_cost, -10519542.780046422, rtol=1e-2)
    assert np.allclose(units.get_heating_duty(), 310.12068230882005, rtol=1e-2)
    assert np.allclose(units.get_cooling_duty(), 360.8848706768206, rtol=1e-2)
    assert np.allclose(units.get_electricity_consumption(), 24.318643729274044, rtol=1e-2)
    assert np.allclose(units.get_electricity_production(), 46.187471088512545, rtol=1e-2)
    bst.process_tools.default()
...
def test_sugarcane():
    ...
    units = UnitGroup('Biorefinery', tea.units)
    assert np.allclose(tea.IRR, 0.11796137285955077, rtol=1e-2)
    assert np.allclose(feedstock.price, 0.03455, rtol=1e-2)
    assert np.allclose(product.price, 0.789, rtol=1e-2)
    assert np.allclose(tea.sales, 86924100.80071607, rtol=1e-2)
    assert np.allclose(tea.material_cost, 59825858.74237168, rtol=1e-2)
    assert np.allclose(tea.installed_equipment_cost, 203545420.8419712, rtol=1e-2)
    assert np.allclose(tea.utility_cost, -17786489.334216338, rtol=1e-2)
    assert np.allclose(units.get_heating_duty(), 298.39075879543816, rtol=1e-2)
    assert np.allclose(units.get_cooling_duty(), 290.5343463432675, rtol=1e-2)
    assert np.allclose(units.get_electricity_consumption(), 15.45970633856049, rtol=1e-2)
    assert np.allclose(units.get_electricity_production(), 73.06610647013277, rtol=1e-2)
    bst.process_tools.default()
...
def test_LAOs():
    ...
    assert np.allclose(product.price, 1.3079736186229198, rtol=1e-2)
    assert np.allclose(tea.sales, 158947937.7235253, rtol=1e-2)
    assert np.allclose(tea.material_cost, 135664645.22908747, rtol=1e-2)
    assert np.allclose(tea.installed_equipment_cost, 54498602.49663154, rtol=1e-2)
    assert np.allclose(tea.utility_cost, 526581.9395732596, rtol=1e-2)
    assert np.allclose(units.get_heating_duty(), 37.83052977683851, rtol=1e-2)
    assert np.allclose(units.get_cooling_duty(), 123.63183789617825, rtol=1e-2)
    assert np.allclose(units.get_electricity_consumption(), 3.7688458632647426, rtol=1e-2)
    assert np.allclose(units.get_electricity_production(), 3.7688458632647426, rtol=1e-2)
    bst.process_tools.default()
def test_lactic():
    bst.process_tools.default()
