...
get_annual_factor = lambda: orgacids_sys_no_boiler_tea._annual_factor
...
LA_yield_parameters = tuple([i for i in parameters
                             # if not i.name in ('Lactic acid yield', 'Succinic acid content')])
                              if not i.name=='Lactic acid yield'])
