...
#!!! Consider estimating Hc based on Dulong's equation
...
chemical_IDs = [
        ...
        'Xylitol', 'NH3', 'H2SO4', 'NH4SO4', 'AmmoniumAcetate', 
        ...
        'FermentationMicrobe', 'T_reesei', 'Biomass', 
        'Tar', 'CalciumDihydroxide', 'CaSO4', 'Graphite', 'N2', 'O2', 'CO2',
...
def set_rho(single_phase_chemical, rho):
    V = fn.rho_to_V(_rho, single_phase_chemical.MW)
    single_phase_chemical.V.add_model(V, top_priority=True)


# %% Define chemicals, properties largely from Appendix D in Humbird et al.

# TODO: Add heats of combustion

# As it is in data bank
chems.extend(tmo.Chemicals(['Water', 'Ethanol', 'AceticAcid', 'Furfural', 'H2SO4',
...
# Amend chemical properties, need to double-check data source
# TODO: add those needed for other organic acids,
# seems like need a function to calculate molecular volume
chems.H2SO4.at_state('l')
chems.LacticAcid.Tb = 240 + 273.15
chems.LacticAcid.Hf = -163122*_cal2joule # from cornstover biorefinery
chems.LacticAcid.load_free_energies()
# Added by Yoel on 2020-02-25
chems.Methanol.Hc = 715e3
chems.MethylAcetate.Hc = 1584337

# Add chemicals that will always stay in one (the default reference) phase
# Liquids
append_single_phase_chemical('HNO3', 'NitricAcid')
#!!! Maybe don't need denaturant if Ethanol not generated as a final product
...
#!!! Where is oil needed? Remove if no needs
...
# Analagous vapors
append_new_single_phase_chemical('NO2', chems.N2, MW=46.01, Hf=7925*_cal2joule)
...
append_single_phase_chemical('CalciumDihydroxide')
#!!! 1.02388 from CaO in lipidcane biorefinfery, might need to update to Ca(OH)2
set_Cp(chems.CalciumDihydroxide, 1.02388)
append_new_single_phase_chemical('Graphite')

# Copy properties
subgroup = chems.retrieve(['Glucose', 'Xylose', 'Sucrose',
                           'CaSO4', 'Graphite', 'AmmoniumSulfate'])
for chemical in subgroup: set_Cp(chemical, _Cp_cellulosic)
...
append_new_single_phase_chemical('Lignin', Hf=-108248*_cal2joule, MW=152.15)
set_rho(chems.Lignin, 1540)
set_Cp(chems.Lignin, _Cp_cellulosic)
append_chemical_copy('SolubleLignin', chems.Lignin)

# Carbohydrate oligomers
append_chemical_copy('GlucoseOligomer', chems.Glucose)
set_Cp(chems.GlucoseOligomer, _Cp_cellulosic)
...
set_Cp(chems.XyloseOligomer,_Cp_cellulosic)
...
#!!! Need to find a better Hc
append_new_single_phase_chemical('FermentationMicrobe', MW=24.6265, 
                                 Hf=-31169.39*_cal2joule, Hc=_Hc_cellulosic)
# T. reesei is the species used to produce cellulase enzyme for enzymatic hydrolysis
append_new_single_phase_chemical('T_reesei', MW=23.8204, Hf=-23200.01*_cal2joule)
append_new_single_phase_chemical('Biomass', MW=23.238, Hf=-23200.01*_cal2joule)
append_new_single_phase_chemical('Cellulose', MW=162.1406, Hf=-233200.06*_cal2joule,
                                 Hc=_Hc_cellulosic)
#!!! Need to find a better Hc
append_new_single_phase_chemical('Protein', MW=22.8396, Hf=-17618*_cal2joule,
                                 Hc=_Hc_cellulosic)
append_new_single_phase_chemical('Enzyme', MW=24.0156, Hf=-17618*_cal2joule)
append_new_single_phase_chemical('Glucan', MW=162.14, Hf=-233200*_cal2joule)
append_new_single_phase_chemical('Xylan', MW=132.12, Hf=-182100*_cal2joule)
append_new_single_phase_chemical('Xylitol', MW=152.15, Hf=-243145*_cal2joule)
append_new_single_phase_chemical('Cellobiose', MW=342.30, Hf=-480900*_cal2joule)
...
append_new_single_phase_chemical('WWTsludge', MW=23.24, Hf=-23200*_cal2joule)
