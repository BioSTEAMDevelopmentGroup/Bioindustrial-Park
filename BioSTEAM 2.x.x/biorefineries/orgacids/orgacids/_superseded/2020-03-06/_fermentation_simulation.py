...
import numpy as np
import pandas as pd
from orgacids.system import (feedstock_sys, pretreatment_sys, fermentation_sys, 
                             R301, R302)
...
with pd.ExcelWriter('_out_fermentation_data.xlsx') as writer:
