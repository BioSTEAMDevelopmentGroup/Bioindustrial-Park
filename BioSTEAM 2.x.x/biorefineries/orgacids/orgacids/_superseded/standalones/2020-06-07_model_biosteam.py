...
class Model(State):
    ...
    def evaluate(self, thorough=True, simulation_number=1):
        ...
        simulation_time: int
            The number of times that the system will be simulated for each evaluation.
        """
        speed_up()
    ...
    def evaluate_across_coordinate(self, name, f_coordinate, coordinate,
        ...
        if notify:
            ...
            timer.tic()
            def evaluate():
                self.evaluate(simulation_number=simulation_number)
        ...
        for n, x in enumerate(coordinate):
            ...
            evaluate(simulation_number=simulation_number)
