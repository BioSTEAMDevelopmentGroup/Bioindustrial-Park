...
TODO:
    ...
    T401 missing, separation_sulfuric_acid might not be updating correctly,
        might take a look at the system0.py, although that design is definitely
        not correct
'''
...
orgacids_sub_sys = {
    ...
    'fermentation_sys': (H301, M301, M302, R301, R302, T301, M303),
    'separation_sys': (U401, M401, S401, R401, M402, S402, F401, H401, 
                       S4ex, R402, S403, H402, R403, S404, H403, H404,
                       # T401, T401 NOT IN SYSTEM, WILL GIVE ERROR, THUS NOT INCLUDED NOW
                       H_pre_S404, pre_S404, pre_S403, H_S404, F_pre_S404,
                       HXU1, HXP1, Split_S403),
    'wastewater_sys': (M501, WWT_cost, R501, M502, R502, S501, S502, M503, M504, 
                       S503, S504, M505),
    'BT': (BT,),
    'CT': (CT,),
...
alll_units = sum([orgacids_sub_sys[i] for i in orgacids_sub_sys.keys()], ())
