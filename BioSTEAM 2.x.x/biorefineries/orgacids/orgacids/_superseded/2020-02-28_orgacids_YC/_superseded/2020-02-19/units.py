...
class SaccharificationAndCoFermentation(Unit):
    ...
    def _run(self):
        ...
        lime.imol['CaO'] = (effluent.imol['LacticAcid']/2/self.neutralization.X[0] \
                           ...
                           * 1.05
        print(lime.imol['CaO'])
        print(lime.imol['LacticAcid'])
        print(lime.imol['AceticAcid'])
...
class CellMassFilter(bst.units.SolidsSeparator):
    ...
    # Use this to temporarily avoid getting negative flow in boiler and turbogenerator
    # def _run(self):
    #     self.outs[0].T = 315
