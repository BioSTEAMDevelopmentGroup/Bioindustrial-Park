...
from orgacids_YC.EB import EB_simulate
import math
import numpy as np
...
class SeedTrain(Unit):
    ...
    #!!! Should be updated to the modeled acid
    T = 32+273.15
...
# Changed cost of reciruculation pumps to be 47200/5
# (Number of recirculation pump is 5, yet the cost has not been divided by 5)
...
class SaccharificationAndCoFermentation(Unit):
    ...
    #!!! Here and below should be updated
    ...
    def __init__(self, ID='', ins=None, outs=(), P=101325):
        ...
        # Neutralization of lactic acid and acetic acid by lime (CaO)
        self.neutralization = ParallelRxn([
            #   Reaction definition                             Reactant  Conversion
            Rxn('2 LacticAcid + CaO -> CalciumLactate + H2O', 'LacticAcid', 1.),
            Rxn('2 AceticAcid + CaO -> CalciumAcetate + H2O', 'AceticAcid', 1.)
            ])
    ...
    def _run(self):
        ...
        lime.imol['CaO'] = (effluent.imol['LacticAcid']/2/self.neutralization.X[0] \
...
class CellMassFilter(bst.units.SolidsSeparator):
    ...
    def _run(self):
        ...
        recycled_water.imass['Water'] *= cell_mass.F_mass / 391501
...
class AcidulationReactor(Unit):
    ...
    def _run(self):
        ...
        # Set feed acid mol to match acidulation needs
...
class EsterificationReactor(Unit):
    ...
    def _run(self):
        ...
        # Add 5% extra
        methanol.imol['Methanol'] = (feed.imol['LacticAcid']/self.esterification.X[0] \
...
class HydrolysisReactor(Unit):
    ...
    def _run(self):
        ...
        # Add 5% extra
        water.imol['Water'] = (feed.imol['MethylLactate']/self.hydrolysis.X[0] \
