...
from orgacids import units, facilities, hxn
...
Name change:
    ...
    Temperature of HX after distillaiton columns is set to the bubble point
'''
...
# 
# F401_H = bst.units.HXutility('F401_H', ins=PS_F401_H_T-0, V=0)
# =============================================================================

F401_H = bst.units.HXutility('F401_H', ins=F401-0, V=0, T=345)
...
D402_H = bst.units.HXutility('D402_H', ins=D402-0, outs=1-R402, V=0, T=335)
...
# 
# D403_H = bst.units.HXutility('D403_H', ins=PS_D403_H_T-0, V=0)
# =============================================================================

D403_H = bst.units.HXutility('D403_H', ins=D403-0, V=0, T=345)
...
D404_H = bst.units.HXutility('D404_H', ins=D404-0, outs=4-R402, V=0, T=345)
...
F402_H = bst.units.HXutility('F402_H', ins=F402-0, outs=3-R403, V=0, T=345)
...
# Mix waste liquids for treatment, the last slot is reserved for M601,
# which mixes the outs from CIP and blowdowns from BT and CT
...
CIP = facilities.OrganicAcidsCIP('CIP', ins=CIP_chems_in)
...
M601 = bst.units.BlowdownMixer('M601', ins=(CIP.outs[-1], BT.outs[-1], CT.outs[-1]), 
                               outs=M502.ins[-1])
...
# orgacids_sys_no_hxn = System('orgacids_sys_no_hxn',
#     [
# # =============================================================================
# #    Feedstock preprocessing
# # =============================================================================
...
# orgacids_sys_no_hxn = bst.main_flowsheet.create_system(
#     'orgacids_sys_no_hxn', feeds=[i for i in bst.main_flowsheet.stream
#                                   if i.sink and not i.source])

HXN = hxn.hx_network.HX_Network('HXN')

orgacids_sys = bst.main_flowsheet.create_system(
    'orgacids_sys', feeds=[i for i in bst.main_flowsheet.stream
                           if i.sink and not i.source])

# BT._system = None
# CT._system = None

# orgacids_sys = System('orgacids_sys', [orgacids_sys_no_hxn],
#                       facilities=(HXN, BT, CT))

# orgacids_sys.path = [orgacids_sys_no_hxn.simulate]
