...
class OrganicAcidsCT(Facility):
    ...
    #!!! system_cooling_utilities is before HXN, might want to hide
    def __init__(self, ID='', ins=None, outs=(), ratio=0):
...
#!!! After Yoel makes the auxiliary unit option, change the tank to 
# a OrganicAcidsStorageTank, Pump to OrganicAcidsPump (tau=8 h, page 55 of Humbird)
