...
def create_lipidcane_to_biodiesel_and_ethanol_1g(
    ...
    HXN = bst.HeatExchangerNetwork(900, 
        ignored=[u.D601.boiler, u.D602.boiler, u.H601, u.H602, u.H603, u.H604, u.H402],
        Qmin=1e5,
    )
...
#         area=300,
#     )
#     vinasse = conventional_beer_distillation_sys.outs[1]
...
#         area=700,
#     )
#     s.stripping_water.ID = 'stripping_water'
...
#     cellulosic_fermentation_sys, udct = brf.cornstover.create_cellulosic_fermentation_system(
#         ins=hydrolyzate,
...
#         kind=1,
#     )
#     udct['M401'].ins.append(conventional_beer)
#     udct['M304'].ins.append(vent_1)
#     vent_2, cellulosic_beer = cellulosic_fermentation_sys.outs
#     beer_distillation_sys = create_beer_distillation_system(
#         ins=cellulosic_beer,
#         outs=[''],
#         mockup=True,
#         area=500,
...
#                                 P=3.9*101325,
#                                 units='kg/hr')
#     PF1 = bst.PressureFilter(500, (beer_distillation_sys-1, recycled_water))
...
#     F301 = sf_dct['F301']
#     D303 = ep_dct['D303']
#     HXN = bst.HeatExchangerNetwork(1200, 
#         units=lambda: [F301.components['evaporators'][0], D303.condenser]
...
def create_lipidcane_to_biodiesel_and_ethanol_combined_1_and_2g_post_fermentation_oil_separation(ins, outs, front_end_oil_separation=False):
    ...
    screened_juice
    EvX = bst.MultiEffectEvaporator(400, ins=screened_juice,
                                    P=(101325, 69682, 47057, 30953, 19781),
                                    V_definition='First-effect',
    ...
    s = f.stream
    u = f.unit
    M501 = bst.Mixer(700, (wastewater_treatment_sys-1, PF1-0, f.stream.filter_cake))
    brf.cornstover.create_facilities(
        solids_to_boiler=M501-0,
        gas_to_boiler=wastewater_treatment_sys-0,
        process_water_streams=(s.imbibition_water,
    ...
    HXN = bst.HeatExchangerNetwork(1000,
        ignored=[u.D801.boiler, u.D802.boiler, u.H803, u.H802, u.H801, u.H804, u.H602],
        Qmin=1e3,
    )
    HXN.acceptable_energy_balance_error = 0.01
    # ignored=transesterification_and_biodiesel_separation_sys.units)
...
#                                 P=3.9*101325,
#                                 units='kg/hr')
#     PF1 = bst.PressureFilter(800, (beer_distillation_sys-1, recycled_water))
#     wastewater_treatment_sys = bst.create_wastewater_treatment_system(
#         ins=[PF1-1, 
#              *juicing_and_lipid_extraction_sys-[3, 4], 
#              pretreatment_wastewater],
...
#         ignored=[u.D801.boiler, u.D802.boiler],
#     )#, ignored=transesterification_and_biodiesel_separation_sys.units)
