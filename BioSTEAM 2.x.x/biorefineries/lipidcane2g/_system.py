...
@SystemFactory(
    ID='create_lipid_expression_sys',
...
@SystemFactory(
    ID='lipidcane_sys',
    ins=create_lipidcane_to_biodiesel_and_ethanol_1g.ins,
    outs=(create_lipidcane_to_biodiesel_and_ethanol_1g.outs[:3]
          + create_lipidcane_to_biodiesel_and_ethanol_1g.outs[4:]),
)
def create_lipidcane_to_biodiesel_and_ethanol_combined_1_and_2g_post_fermentation_oil_separation(ins, outs):
    pass
