...
F401 = bst.units.Flash('F401', ins=S401-1, outs=('F401_g', 'F401_l'),
                                    V = 0.5, P = 101325/70,
                                    vessel_material = 'Stainless steel 316')

# def adjust_F401_V():
#     instream = F401.ins[0]
#     F401.V = (instream.imol['H2O'] + instream.imol['HP'])/instream.F_mol
#     F401._run()

# F401.specification = adjust_F401_V

def get_F401_bottom_HP_mol(V):
    F401.V = V
    F401._run()
    bottom = F401.outs[1]
    return bottom.imol['HP'] - 10

F401.specification = BoundedNumericalSpecification(get_F401_bottom_HP_mol, 0.001, 0.999)
...
D401 = bst.units.ShortcutColumn('D401', ins=F401_H-0, outs=('D401_g', 'D401_l'),
                                    LHK=('H2O', 'HP'),
                                    is_divided=True,
...
# D401_P_H = bst.units.HXutility('D401_P_H', ins=D401_P-0, T=303, rigorous=True)



R401 = units.DehydrationReactor('R401', ins = (D401_P-0),
...
D402 = bst.units.ShortcutColumn('D402', ins=R401-0, outs=('D402_g', 'D402_l'),
                                    LHK=('H2O', 'AcrylicAcid'),
                                    is_divided=True,
                                    product_specification_format='Recovery',
                                    Lr=0.9999, Hr=0.9999, k=1.2,
...
# F402 = bst.units.Flash('F402', ins=D402_P-0, outs=('F402_g', 'F402_l'),
...
# F402_P = units.HPPump('F402_P', ins=F402-1)
