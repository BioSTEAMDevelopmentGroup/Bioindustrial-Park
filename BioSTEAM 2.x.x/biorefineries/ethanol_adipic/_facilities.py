...
from biorefineries.ethanol_adipic._utils import CEPCI
...
class CT(Facility):
    ...
    of cooling water as in [1] and [2].
...
class CHP(Facility):
    ...
    of the ins. Purchase natural gas if CHP cannot meet system heating/steam demand.
