...
NH4OH = chemical_database('NH4OH', search_ID='AmmoniumHydroxide', phase='l', Hf=-336.719e3)
...
Na2SO4 = chemical_database('Na2SO4', Hf=-1356.38e3)
...
# soluble_organics = sum([chemical_groups[i] for i in soluble_groups], ('Enzyme',))

# soluble_organics = list(sum([chemical_groups[i] for i in soluble_groups], ('Enzyme',)))
...
insoluble_groups = ('CellMass', 'OtherInsolubleSolids', 'OtherStructuralCarbohydrates',
                    'Proteins')
