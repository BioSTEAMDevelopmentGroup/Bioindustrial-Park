...
def get_TAL_solubility_in_ethanol_ww():
    return 0.166880 # solubility of 157.425 g-TAL per L-ethanol
...
def create_TAL_sys(ins, outs):
    ...
    U401 = bst.DrumDryer('U401', 
        (P402-0, 'dryer_air', 'dryer_natural_gas'), 
        ('', 'dryer_outlet_air', 'dryer_emissions'),
        moisture_content=0.05, split=0., moisture_ID='Ethanol',
        P=101325*10,
    )
