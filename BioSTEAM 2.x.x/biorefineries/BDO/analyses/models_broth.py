...
from biorefineries.BDO.system_broth import BDO_sys, BDO_tea, spec, feedstock, conc_aqueous_broth, BT, BDO_lca, unit_groups_dict
...
default_price_streams = ('sulfuric_acid_T201', 'enzyme', 
                         'makeup_water', 'caustic', 'ash_disposal', 
                         # 'oleyl_alcohol',
...
# conc_aqueous_broth = flowsheet.stream.conc_aqueous_broth
##############################################################################################
...
def create_feedstock_price_metrics(price):
    def get_price_based_MSP():
        ...
        return BDO_tea.solve_price(conc_aqueous_broth)
...
metrics = [Metric('Minimum selling price', lambda: BDO_tea.solve_price(conc_aqueous_broth)*conc_aqueous_broth.F_mass/conc_aqueous_broth.imass['BDO'], '$/kg'),
...
##### LCA #####
metrics.extend((
    Metric('Total GWP', lambda: (conc_aqueous_broth.F_mass/conc_aqueous_broth.imass['BDO'])*BDO_lca.GWP, 'kg CO2-eq/kg', 'LCA'),
    Metric('Total FEC', lambda: (conc_aqueous_broth.F_mass/conc_aqueous_broth.imass['BDO'])*BDO_lca.FEC, 'MJ/kg', 'LCA')
    ))
