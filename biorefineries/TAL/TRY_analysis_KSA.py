...
from biorefineries.TAL.system_SA_solubility_exploit_ethanol_sugarcane import TAL_sys, TAL_tea, R302, spec, KSA_product, per_kg_KSA_to_per_kg_SA
...
product_chemical_IDs = ['SorbicAcid', 'PotassiumSorbate']
get_product_MPSP = lambda: per_kg_KSA_to_per_kg_SA * TAL_tea.solve_price(product) * 907.185 / get_product_purity() # USD / ton
