...
def load_hydrogenation_cat_rep_rate(rate):
    R401.spent_catalyst_replacements_per_year = rate
...
spec_upgrading.load_spec_1, spec_upgrading.load_spec_2, spec_upgrading.load_spec_3 = \
    load_hydrogenation_cat_rep_rate, load_hydrogenation_time, load_hydrogenation_cat_price
...
x_label = r"$\bfHydrogenation$" + " " + r"$\bfCatalyst$" + " " + r"$\bfReplacement$" + " " + r"$\bfRate$"# title of the x axis
x_units = r"$\mathrm{y}^{-1}$"
