...
#%%
def run_TRY_analysis(feedstock, yields=None, titers=None, productivities=None, return_YT_arrays=False, plot=False, steps_for_default_YT=50, which_fig='insights', print_status_every_n_simulations=50):
    # Run this cell first
    ...
    if feedstock == 'glucose':
        from biorefineries.TAL.systems.system_TAL_solubility_exploit_ethanol_glucose import TAL_tea, TAL_lca, R302, spec, TAL_product, simulate_and_print, theoretical_max_g_TAL_per_g_SA,\
            F301, F301_P, M304
        ...
        from biorefineries.TAL.systems.system_TAL_solubility_exploit_ethanol_corn import TAL_tea, TAL_lca, R302, spec, TAL_product, simulate_and_print, theoretical_max_g_TAL_per_g_SA,\
            F301, F301_P, M304
    ...
    steps = (steps_for_default_YT, steps_for_default_YT, 1)
    ...
    if return_YT_arrays:
        ...
        return yields, titers, inflection_product_yields, results_metric_1, results_metric_2, results_metric_3, results_metric_4, results_metric_5, results_metric_6
    else:
        return results_metric_1, results_metric_2, results_metric_3, results_metric_4, results_metric_5, results_metric_6
