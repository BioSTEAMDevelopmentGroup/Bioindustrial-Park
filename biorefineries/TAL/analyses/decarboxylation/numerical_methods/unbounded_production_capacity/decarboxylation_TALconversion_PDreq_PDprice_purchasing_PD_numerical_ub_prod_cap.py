...
def solve_addition_for_mol_ratio_and_decarb_conv(mol_PD_per_mol_TAL, x):
...
for p in PD_prices:
    ...
    file_to_save = f'_{steps}_steps_'+'TAL_decarboxylation_purchasing_PD_unbounded_prod_cap%s.%s.%s-%s.%s'%(dateTimeObj.year, dateTimeObj.month, dateTimeObj.day, dateTimeObj.hour, minute)
