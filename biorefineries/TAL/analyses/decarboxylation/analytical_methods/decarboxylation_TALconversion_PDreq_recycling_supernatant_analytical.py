...
spec_2 = S403_recycle_spls = np.linspace(0.01, 0.99, steps[1]) # titer
...
# spec.load_specifications(TAL_decarb_convs[0], S403_recycle_spls[0], PD_prices[0])
...
curr_no = 0
total_no = len(TAL_decarb_convs)*len(S403_recycle_spls)*len(PD_prices)
...
contourplots.animated_contourplot(w_data_vs_x_y_at_multiple_z=results_metric_1, # shape = z * x * y # values of the metric you want to plot on the color axis; e.g., MPSP
                                ...
                                y_data=S403_recycle_spls, # y axis values
