# -*- coding: utf-8 -*-
"""
TEA Configuration for HemDx system using _config1_new (Internalized Specifications).
...
from biorefineries.prefers.v1.HemDx.system._config1_new import seed_targets
...
class PreFerSTEA(PreFerSTEA_Base):
    ...
    def set_production_rate(self, target_production_kg_hr, verbose=True):
        ...
        """
        from biorefineries.prefers.v1.HemDx.system._config1_new import set_production_rate
    ...
    def check_product_specifications(self):
        ...
        """
        from biorefineries.prefers.v1.HemDx.system._config1_new import check_HemDx_specifications
...
if __name__ == '__main__':
    import argparse
    from biorefineries.prefers.v1.HemDx.system._config1_new import create_NHemDx_system
