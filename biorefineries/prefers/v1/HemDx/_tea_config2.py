# -*- coding: utf-8 -*-
"""
HemDx TEA Configuration - Config 2 (Intracellular, SF=0.1)

Based on Config 1, modified for intracellular production.
"""
...
from biorefineries.prefers.v1.HemDx.system._config2 import seed_targets
...
class PreFerSTEA(PreFerSTEA_Base):
    ...
    def optimize_NH3_loading(self, verbose=True):
        ...
        """
        from biorefineries.prefers.v1.HemDx.system._config2 import optimize_NH3_loading
    ...
    def set_production_rate(self, target_production_kg_hr, verbose=True):
        ...
        Delegates to system module implementation.
        """
        from biorefineries.prefers.v1.HemDx.system._config2 import set_production_rate, adjust_glucose_for_titer
...
if __name__ == '__main__':
    import argparse
    from biorefineries.prefers.v1.HemDx.system._config2 import create_NHemDx_system
