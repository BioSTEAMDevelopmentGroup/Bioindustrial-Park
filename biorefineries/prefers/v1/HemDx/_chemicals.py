...
chemical_groups = dict(
    ...
    SolidsCentrifuge = {'Corynebacterium_glutamicum': 0.98,
                        'Xylan': 0.85,
                        'Protein': 0.85,
                        'Cellulose': 0.85,
                        'OleicAcid': 0.85,
                        'RNA': 0.85,
                        'Heme_b_In': 0.98,
                        'ProtoporphyrinIX_In': 0.98,
    },
    
    FilteredSubstances = ('Corynebacterium_glutamicum',
                        'Xylan',
                        'Protein',
                        'Cellulose',
                        'OleicAcid',
...
def create_chemicals_LegHb():
    ...
    # Ensure gas species include full phase models (liquid Cp/Hvap)
