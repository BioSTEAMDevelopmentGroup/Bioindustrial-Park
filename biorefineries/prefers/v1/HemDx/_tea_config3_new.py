# -*- coding: utf-8 -*-
"""
TEA Configuration for HemDx system using _config3_new (Internalized Specifications).
...
from biorefineries.prefers.v1.HemDx.system._config3_new import seed_targets
...
class PreFerSTEA(PreFerSTEA_Base):
    ...
    # in _config3_new.py (empirical measurement per titer iteration).
    ...
    def set_production_rate(self, target_production_kg_hr, verbose=True):
        ...
        Delegates to _config3_new.set_production_rate which:
          - Scales all input streams proportionally
          - Relies on R302 spec for titer/NH3 convergence (no external loops)
        """
        from biorefineries.prefers.v1.HemDx.system._config3_new import set_production_rate
    ...
    def check_product_specifications(self):
        ...
        """
        from biorefineries.prefers.v1.HemDx.system._config3_new import check_HemDx_specifications
...
if __name__ == '__main__':
    import argparse
    from biorefineries.prefers.v1.HemDx.system._config3_new import create_NHemDx_system
