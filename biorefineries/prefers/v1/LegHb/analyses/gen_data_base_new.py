# -*- coding: utf-8 -*-
"""
Baseline Data Generation for LegHb (NEW — Internalized Specifications)
======================================================================
...
Key differences vs gen_data_base.py:
    - Imports _models_new.create_model (no config parameter — config1 only)
    - Imports _tea_config1_new.PreFerSTEA
    - No config CLI argument (always config1)
"""
...
from biorefineries.prefers.v1.LegHb._models_new import create_model
from biorefineries.prefers.v1.LegHb._tea_config1_new import PreFerSTEA
...
def generate_baseline(baseline_production_kg_hr=275, timestamp=None, results_dir=None):
    config = 'config1'  # _models_new only supports config1
