...
def create_LegHb_system(
    ...
    - M401, H402, M402: Cell wash system
    ...
    - M503: Collect solid debris for disposal
    ...
    - M503: Solid waste routing mixer
    ...
    M503 = bst.Mixer('M503', ins=S404-0, outs=debris_disposal)
