...
def create_LegH_system(
    ...
    return LegH_3, vent1, vent2, effluent1, effluent2, effluent3, effluent4, effluent5, DfUltraBuffer, IXEquilibriumBuffer, IXElutionBuffer, IXRegenerationSolution, DfNanoBuffer
