# -*- coding: utf-8 -*-
"""
TEA Configuration for HemDx system using _config2 (Internalized Specifications).
...
from biorefineries.prefers.v2.HemDx.system._config2 import seed_targets
...
class PreFerSTEA(PreFerSTEA_Base):
    ...
    # in _config2.py (empirical measurement per titer iteration).
    ...
    def set_production_rate(self, target_production_kg_hr, verbose=True):
        ...
        Delegates to _config2.set_production_rate which:
          - Scales all input streams proportionally
          - Relies on R302 spec for titer/NH3 convergence (no external loops)
        """
        from biorefineries.prefers.v2.HemDx.system._config2 import set_production_rate
    ...
    def check_product_specifications(self):
        ...
        """
        from biorefineries.prefers.v2.HemDx.system._config2 import check_HemDx_specifications
...
if __name__ == '__main__':
    import argparse
    from biorefineries.prefers.v2.HemDx.system._config2 import create_NHemDx_system
