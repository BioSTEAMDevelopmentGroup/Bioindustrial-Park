# -*- coding: utf-8 -*-
"""
Baseline Data Generation for HemDx (v2 - Internalized Specifications)
=====================================================================

Uses internalized R302 add_specification approach for fast convergence.

Imports:
    - _models.create_model (supports config1/2/3)
...
from biorefineries.prefers.v2.HemDx._tea_config1 import PreFerSTEA
