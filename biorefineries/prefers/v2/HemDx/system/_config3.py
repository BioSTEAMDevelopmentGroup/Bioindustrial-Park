# -*- coding: utf-8 -*-
"""
N-HemDx Full Production System - Config 3 NEW (Internalized Specifications)

Refactored from _config3.py to embed titer control (adjust_glucose_for_titer)
...
def set_production_rate(system, target_production_rate_kg_hr, verbose=True):
    ...
    Simplified compared to _config3.py:
...
if __name__ == '__main__':
    ...
    print("="*85)
    print("N-HemDx FULL PRODUCTION SYSTEM - Config 3 NEW (Extracellular, Internalized Specs)")
    print("="*85)
