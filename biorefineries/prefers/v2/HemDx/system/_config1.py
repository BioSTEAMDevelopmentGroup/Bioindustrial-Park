# -*- coding: utf-8 -*-
"""
N-HemDx Full Production System - Config 1 NEW (Internalized Specifications)
...
def create_area_400_recovery(broth_in, DfUltraBuffer2):
    ...
    # Debris Dewatering
    M404 = bst.Mixer('M404', ins=(C403-0, S405-0, S404-0), outs='CellDebrisRaw')
    S406 = bst.ScrewPress(
...
def create_area_500_purification(lysate_in, NaCl_wash, NaOH_elute, Ethanol_regen, DfUltraBuffer1):
    ...
    M504 = bst.MixTank('M504', ins=(DfUltraBuffer1, 'Water8'), outs='DFBuffer', tau=0.5)
    ...
    def adjust_df_buffer():
        ...
        M504.ins[0].imol['DfUltraBuffer'] = buffer.imass['H2O'] * (0.025 + 0.01 + 0.001) / 1000
...
def create_area_900_facilities(waste_streams, dehydrated_debris, ProcessWaste, emissions, ash_disposal):
    ...
    # Add Supplemental NH4SO4 for WWTP biology (since fermentation effluent is nitrogen-depleted)
