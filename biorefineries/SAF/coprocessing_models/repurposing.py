...
ethanol = F.ethanol_to_upgrading
jet_fuel = F.jet_fuel
diesel = F.diesel
gasoline = F.gasoline
...
def create_model(system=sys,
    ...
    if N > 0:
        ...
        model.show()
        model.table.to_excel('model_table_repurposing_cr.xlsx')
        df_rho,df_p = model.spearman_r()
        df_rho.to_excel('df_rho_repurposing_cr.xlsx')
        df_p.to_excel('df_p_repurposing_cr.xlsx')
    else:
        model.show()
    return model
