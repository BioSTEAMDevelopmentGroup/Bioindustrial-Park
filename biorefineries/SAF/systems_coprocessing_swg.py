...
def preprocessing_sys(ins,outs):
    ...
    U102 = bst.MockMixer('U102', ins=tc, outs='') # transport cost unit
    @U102.add_specification(run=True)
    def transport_cost():
        tc = U102.ins[0]
        tc.reset_flow(Water=1, phase='l', units='kg/hr', total_flow=U101.ins[0].F_mass)
