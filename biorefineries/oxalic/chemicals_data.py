...
__all__ = ('oxalic_chemicals', 'chemical_groups', 'soluble_organics', 'combustibles')

# chems is the object containing all chemicals used in this biorefinery
chems = oxalic_chemicals = tmo.Chemicals([])
...
OxalicAcid = chemical_database('OxalicAcid', search_ID='OxalicAcid')

# CalciumOxalate = chemical_database('CalciumOxalate', search_ID='CalciumOxalate')
...
defined_chemicals = {
    ...
    'SodiumSulfate', 'NH4OH', 'IBA', *[i.ID for i in oxalic_chemicals]
}

# oxalic_chemicals.extend([i for i in sc.chemicals if i.ID not in defined_chemicals])
...
chems.set_synonym('AmmoniumSulfate', 'NH42SO4')
