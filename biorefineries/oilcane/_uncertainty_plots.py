...
def plot_spearman(configurations, labels=None, metric=None, 
    ...
    index, ignored_list = zip(*[
        ...
        (f'Cellulosic ethanol price [0.561, 0.842, 1.087 {stream_price}]', ['S1', 'O1']),
        (f'Advanced ethanol price [0.430, 0.568, 0.664 {stream_price}]', []),
        (f'Biodiesel price [0.871, 0.994, 1.155 {stream_price}]', []),
