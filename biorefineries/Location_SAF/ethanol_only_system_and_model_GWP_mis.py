...
# evaluate_SS('cornstover', N=1000, notify_runs = 0) # refinery name is 'cornstover' but is using switchgrass, I didn't change the name



# It shouldn't give problems with this any more but...
# If there is a problem when running 2 different evaluate_SS(), keeping the feestock price from
...
# units='kg/hr',
# price=0.08572288) #0.08 $/kg

#MISCANTHUS
swg = bst.Stream('switchgrass', # it is called switchgrass but is miscanthus
Water=0.2,
Ash=0.0301,
Glucan=0.3472,
Xylan=0.2048,
...
Acetate=0.0034,
Protein=0.0058,
total_flow= 109236.2081, # TODO: check this value
units='kg/hr',
price=0.08)

# Emily used this composition:
            # 'Glucan':0.3448,
            # 'Xylan':0.1672,
            # 'Galactan':0.0168,
            # 'Arabinan':0.0208,
