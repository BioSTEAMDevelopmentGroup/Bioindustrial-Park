...
Water=0.2,
total_flow=127538.3908, #118199.77918567687, # from location model 80MMGal ethanol refinery # 104229.16 original value, #VERIFICAR BIEN # TODO
units='kg/hr',
price=0.07) #0.08 $/kg
...
def create_states_model(biorefinery):#, feed_price):
    ...
    if biorefinery == 'cornstover':
        ...
        # D = shape.Triangle(1000000/24/0.8, 2000000/24/0.8, 3000000/24/0.8) # TODO: CHANGE
        ...
        # D = shape.Uniform(-0.18363*0.8, -0.10874*0.8) # TODO: change 
        # @model.parameter(name='Feedstock GWP', element='Feedstock', kind='isolated', units='kg CO2-eq/kg',
...
def evaluate_SS(biorefinery, N=3000, notify_runs=0):#, feed_price = tea.feedstock.price): # TODO: change N
    ...
    model.evaluate(**evaluate_args('SS'), notify=notify_runs)
    model.show()
