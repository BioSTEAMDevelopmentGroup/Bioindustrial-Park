# Project Overview
This repository supports the modeling work presented in the manuscript Bianco *et al.*<sup>1</sup>, and includes tools to simulate and analyze the supply chain of sustainable aviation fuel (SAF) from feedstock transport to final fuel production. The repository includes:  
...
## Citation
1. Bianco, M. F.; Guo, W.; Khanna, M.; Guest, J. S. Co-Location of Cellulosic Bioethanol and Alcohol-to-Jet (ATJ) Production Facilities for Targeted Scale-Up of Sustainable Aviation Fuel (SAF) Production. Environ. Sci. Technol. 2026, 60 (7), 5505–5517. DOI: 10.1021/acs.est.5c17460