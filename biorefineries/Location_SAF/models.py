...
import blocs as blc
from blocs.incentives.incentives_tea import CellulosicIncentivesTEA



# from location_sw import feedstock_delivered_price_sw, feedstock_delivered_GHG_sw, kg_sw_hr
# feedstock delivered price and GHG include farm and transportation for 1,000 locations
...
tea_SAF = create_SAF_tea(sys=sys, cls=CellulosicIncentivesTEA) # quizas no hace falta cls si lo pongo directamente en SAF._tea
...
metrics = [Metric('Coprocessing ratio', get_coprocessing_ratio, ''),
           ...
           Metric('NPV', get_NPV, '10^6 $/yr'), # change unit
