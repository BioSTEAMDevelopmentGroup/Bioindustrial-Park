...
def create_chemical_LegH(set_thermo=True,yeast_includes_nitrogen=False):
    ...
    CaCl2 = add_chemical('CaCl2', phase='l', default=True)
    ZnSO4 = add_chemical('ZnSO4', phase='l', default=True)
    MnSO4 = add_chemical('MnSO4', phase='l', default=True)
    CoCl2 = add_chemical('CoCl2', phase='l', default=True)
    CuSO4 = add_chemical('CuSO4', phase='l', default=True)
    NH4_6Mo7O24 = add_chemical('(NH4)6Mo7O24', search_ID='PubChem=61578', phase='l', default=True)
    Na2B4O7 = add_chemical('Na2B4O7', phase='l', default=True)

    # feed2
    NH4_2SO4 = add_chemical('(NH4)2SO4', phase='l', default=True, Hf=-288994*_cal2joule)
    # FeSO4
    # ZnSO4
