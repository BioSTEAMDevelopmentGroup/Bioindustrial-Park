...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 20 13:20:57 2025
...
class CoFermentation(StirredTankReactor):
    ...
    g_zincsulfate_heptahydrate_per_g_succinic_acid = 0.0043# IBRL batch run
    
    g_magnesiumchloride_hexahydrate_per_g_succinic_acid = 0.203 # IBRL batch run
    
    # in excel sheet Chemicals					
# CSL (10g.L-1)			1000	g	Calculated for 100 L volume
# Magnesium Chloride.6H2O (0.203 g.L-1)			20.3	g	
# Zinc Sulfate heptahydrate (0.0043 g.L-1)			0.43		 so 1L of solution contains 78.37 g of SA as per titer value so 
  # g_magnesiumchloride_hexahydrate_per_g_succinic_acid = 0.203/78.37  # 
    ...
    def _init(self, ID='', ins=None, outs=(), thermo=None, *, T=30+273.15,
                 ...
                 kW_per_m3=0.02 * 0.7457 / 0.300, # including non-working volume # 0.02 HP for IBRL 75 L reactor
...
class NH4OHStorage(Unit): pass
#TODO changes teh lime to NH4OH storage 
