...
# -*- coding: utf-8 -*-
"""
Created on Fri Aug  1 21:44:08 2025
...
succinic_filepath = os.path.dirname(succinic_upgraded.__file__)
succinic_results_filepath = os.path.join(succinic_filepath, 'analyses','results')
...
modes = ['lab_batch', 'lab_fed-batch', 'pilot_batch', 'pilot_batch_upgraded_dextrose']
