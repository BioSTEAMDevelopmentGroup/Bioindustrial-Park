...
# evaluate_uncertainties(kind='SHF', seed=None, N_simulation=10, sampling_rule='L',
#                         percentiles = [0, 0.05, 0.25, 0.5, 0.75, 0.95, 1],
#                         if_plot=True, report_name='1_full_evaluation.xlsx')

model_SSCF = evaluate_uncertainties(kind='SSCF', seed=None, N_simulation=10, sampling_rule='L',
                        percentiles = [0, 0.05, 0.25, 0.5, 0.75, 0.95, 1],
                        if_plot=False, report_name=None)

model_SHF = evaluate_uncertainties(kind='SHF', seed=None, N_simulation=10, sampling_rule='L',
                        percentiles = [0, 0.05, 0.25, 0.5, 0.75, 0.95, 1],
                        if_plot=False, report_name=None)