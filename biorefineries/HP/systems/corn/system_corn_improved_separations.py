...
HP_lca = HPLCA(system=HP_sys, 
                 ...
                 input_biogenic_carbon_streams=(s.feedstock, s.CSL_fresh), # any streams, including feedstock, for which CO2 fixing credit is non-zero and has not already been included in GWP impact CFs
                 )
