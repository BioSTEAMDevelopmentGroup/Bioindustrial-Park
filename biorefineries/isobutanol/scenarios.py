...
SCENARIOS = {
    ...
    # implementation plan, Task 5. Values pasted verbatim from its output.
    # burden_default=False FOR NOW on every opt_* scenario: their workbooks
    # were generated by studies run burden-free, so their baseline points
    # are not yet re-verified against the enzyme-burden proteome cap. Task 6
    # flips these to True after regenerating the workbooks under the burden.
    'opt_IRR': ScenarioSpec(
        ...
        expected={'ethanol': 0.4050972501352521, 'isobutanol': 1.2843256644750263},
        objective_name='IRR', objective_value=0.2350221277168978,
        burden_default=False),
    'opt_IBO_titer': ScenarioSpec(
        ...
        expected={'ethanol': 6.7999075346228866, 'isobutanol': 1.8282925822006733},
        objective_name='IBO titer', objective_value=102.09908961706607,
        burden_default=False),
    'opt_IBO_yield': ScenarioSpec(
        ...
        expected={'ethanol': 6.644206357250057, 'isobutanol': 1.7100720857578882},
        objective_name='IBO yield', objective_value=0.2604100005305974,
        burden_default=False),
    'opt_EtOH_titer': ScenarioSpec(
        ...
        expected={'ethanol': 0.8296066837854006, 'isobutanol': -2.4907811766498904},
        objective_name='EtOH titer', objective_value=269.85590533678345,
        burden_default=False),
    'opt_EtOH_yield': ScenarioSpec(
        ...
        expected={'ethanol': 0.8366325361804745, 'isobutanol': 5.10514664534597},
        objective_name='EtOH yield', objective_value=0.48588561216089865,
        burden_default=False),
}
