...
SCENARIOS = {
    ...
    # opt_EtOH_titer / opt_EtOH_yield: the 2026-09-07/08
    # metabolic_minimal_subset studies, workbooks generated by
    # analyses/build_opt_scenario_workbooks.py (ask-first). opt_IRR: since
    # 2026-09-20 trial 1602 of the metabolic_split_12d PI (log-tail) GP
    # study, workbook generated by
    # analyses/build_opt_IRR_split12d_workbook.py (ask-first) -- see the
    # RELOCATED note just above its entry.
    ...
    # -> 2140.7.
    # RELOCATED 2026-09-20 (opt_IRR only; spec docs/superpowers/specs/
    # 2026-09-20-opt-IRR-relocate-to-split12d-optimum-design.md): opt_IRR
    # moved from trial 774 of the 2026-09-07 metabolic_minimal_subset IRR
    # study (18-spike cap / 286.77 / 300.0; ethanol 0.58156 / isobutanol
    # 1.3731; IRR 0.19911) to trial 1602 of the 2026-09-16 scenario-A-
    # anchored metabolic_split_12d PI (log-tail) GP study -- the highest-IRR
    # point of the campaign, a co-production optimum (IBO 41.7 + EtOH 29.2
    # g/L, tau 28.35 h, 1 actual spike under a 50-spike cap, PI 0.81). The
    # PI study is only the SOURCE of the point: the scenario's regression
    # objective stays IRR. New pins: ethanol 0.35881 / isobutanol 1.1635,
    # IRR 0.27299. The workbook = scenario A's live kinetics (INTENDED
    # k_7 / k_8, every K_*) + the trial's k_3 / k_6 / k_13 / k_17 and its
    # glycolysis / ehrlich_downstream / inhib_* group members, so it carries
    # k_17 = 2.154 on the corrected 0.1077 baseline and is burden-FEASIBLE
    # (Phi_M 0.1355) -- smoke test 9 passes again. The other four opt_*
