...
manual_w_levels = np.arange(0.6, 1.2, 0.01) if metric == 'MPSP' else None
manual_cbar_ticks = np.arange(0.6, 1.2, 0.052) if metric == 'MPSP' else None
...
def compute_rowwise_optima(metrics_to_opt, row_max_ns, stage_1_times, z_label, steps):
    rowwise_optima = {}
