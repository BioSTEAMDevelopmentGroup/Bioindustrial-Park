...
# IRR is plotted in percent. Colorbar/levels span -20 % (lower bound) to 20 %
# (upper bound): everything below -20 % falls in the gray under-color, and
# there is NO over-color above 20 % (the grid maxes near 13 %). 0 % and 10 %
# are drawn as white labeled contours (added in main); the only black labeled
# contour is 5 %.
IRR_w_levels = np.arange(-20.0, 20.001, 0.5)
IRR_cbar_ticks = np.arange(-20.0, 20.001, 5.0)     # -20, -15, ..., 15, 20
