...
assert abs(res['MPSPs']['ethanol'] - 0.86867)/0.86867 < 0.01
PASS('scenario A burden ON by default, active, and inert (ethanol MPSP 0.86867)')
...
assert abs(res2['MPSPs']['ethanol'] - 0.86867)/0.86867 < 0.01
