...
if plot: 
    ...
    MPSP_w_levels = np.arange(0.7, 1.001, 0.01)
    MPSP_cbar_ticks = np.arange(0.7, 1.001, 0.05)
    ...
    Yield_w_levels = np.arange(0., 0.601, 0.01)
    Yield_cbar_ticks = np.arange(0., 0.601, 0.05)
