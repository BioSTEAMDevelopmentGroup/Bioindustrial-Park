...
DEFAULT_METRICS = [
    ...
    MetricSpec('Ethanol MPSP', 'ethanol mpsp',
               exclude=('purity-adjusted',),
               fallbacks=('adjusted minimum selling price',), units='$/kg'),
    MetricSpec('Purity-adj. ethanol MPSP', 'purity-adjusted ethanol mpsp',
               fallbacks=('adjusted minimum selling price',), units='$/kg'),
    MetricSpec('Isobutanol MPSP', 'isobutanol mpsp',
               exclude=('purity-adjusted',), units='$/kg'),
    MetricSpec('Purity-adj. isobutanol MPSP', 'purity-adjusted isobutanol mpsp',
               units='$/kg'),
