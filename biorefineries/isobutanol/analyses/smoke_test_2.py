...
def _assert_MPSPs_pinned(expected, current, sim_number, rel_tol=0.01):
    ...
    2026-09-02 for the 2023 price year (every stream and utility price
    ...
    A 0.85293 / B 1.0870 + 1.7961), earlier that day for the 2023
