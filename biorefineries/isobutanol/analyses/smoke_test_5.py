...
- purity-adjusted ethanol MPSP within 1% of 0.74200 (the reference baseline
  for this configuration, set 3-sim-stable by the 2026-09-02 re-pin run;
  slightly below the both-trains A baseline 0.76073 -- the stock
  corn-ethanol purification train is marginally cheaper than the IBO/EtOH
  train for a zero-IBO broth. Re-pinned 2026-09-02 for the Lang factor
  3.0 TEA (Huang et al. 2016; previous pin 0.81943 under corn's uncited
  Lang factor 4), and 2026-09-01 after (a) the
