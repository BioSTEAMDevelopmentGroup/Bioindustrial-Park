...
# for license details.
"""
Smoke test 13 -- scenario opt_EtOH_yield (best EtOH-yield trial #1349 of
the 2026-09-08 metabolic_minimal_subset EtOH-yield study) with ONLY the
IBO/EtOH separation train: ``isobutanol.load(separation_processes=('IBO_EtOH',))``.
...
and the study objective (EtOH yield) reproduced within the registry
