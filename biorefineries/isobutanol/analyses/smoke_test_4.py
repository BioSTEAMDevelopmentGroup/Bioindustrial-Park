...
- purity-adjusted ethanol MPSP within 1% of 0.61216 (was 0.60727 before
...
- purity-adjusted isobutanol MPSP within 1% of 1.2948 (was 1.2864 before the
...
def load_simulate_baseline(stream_IDs=('ethanol', 'isobutanol'),
    ...
    # (0.61216 / 1.2948) to full precision; pins from the registry.
