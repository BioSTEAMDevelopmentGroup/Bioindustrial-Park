...
# for license details.
"""
Smoke test 11 -- scenario opt_IBO_yield (best IBO-yield trial #1538 of the
2026-09-08 metabolic_minimal_subset IBO-yield study) with ONLY the IBO/EtOH
separation train: ``isobutanol.load(separation_processes=('IBO_EtOH',))``.
...
and the study objective (IBO yield) reproduced within the registry
