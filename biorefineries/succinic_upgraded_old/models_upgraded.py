...
# -*- coding: utf-8 -*-
"""
Created on Sat Nov  8 17:27:14 2025
...
from biorefineries.succinic_upgraded.system_dextrose_upgraded import succinic_sys, succinic_tea, succinic_LCA, u, s, unit_groups, unit_groups_dict, spec, price, TEA_breakdown, theoretical_max_g_succinic_acid_per_g_glucose, simulate_and_print
...
metrics.append(Metric('FEC - Feedstock (FGHTP) ', lambda: succinic_LCA.feedstock_FEC, 'MJ/kg', 'Biorefinery'))
metrics.append(Metric('FEC - Materials (except feedstock and BT.natural_gas) ', lambda: succinic_LCA.material_FEC, 'MJ/kg', 'Biorefinery'))
...
metrics.append(Metric(f'FEC - Materials breakdown - CH4', lambda: succinic_LCA.material_FEC_breakdown['CH4'], 'MJ/kg', 'Biorefinery'))
metrics.append(Metric(f'FEC - Materials breakdown - CO2', lambda: succinic_LCA.material_FEC_breakdown['CO2'], 'MJ/kg', 'Biorefinery'))
