...
class CoFermentation(StirredTankReactor):
    ...
    # g_zincsulfate_heptahydrate_per_g_succinic_acid = 0.0043/63.1
    ...
    # g_magnesiumchloride_hexahydrate_per_g_succinic_acid = 0.203/63.1
    # Mg 0.203g/L
    ...
    max_batch_reactor_volume = 0.075 # for 75 L reactor
    ...
    def _run(self):
        ...
        # magnesiumchloride_hexahydrate, zincsulfate_heptahydrate, 
