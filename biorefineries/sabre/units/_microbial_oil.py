...
__all__ = ('YarrowiaLipidFermenter', 'FermentationMediumTank', 'OilExtraction')

# Loaded yaml assumptions
_MICROBIAL_OIL_YAML = load_assumptions("microbial_oil.yaml")
_VFA = _MICROBIAL_OIL_YAML["vfa"]
...
class YarrowiaLipidFermenter(bst.AeratedBioreactor):
    ...
    Q_O2_consumption : float
        ...
        rather than atom-balanced. See data/microbial_oil.yaml
    ...
    **kwargs
    ...
    See Also
    --------
    Refer to data/microbial_oil.yaml for the default values and references.
    """
