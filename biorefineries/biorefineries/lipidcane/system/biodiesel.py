...
#            HNK=('Biodiesel',),
#            LNK=('Methanol',))
# D402.HasGlycolGroups = True
# D402.vessel_material = 'Stainless steel 316'
D402 = Distillation('D402',
                    LHK=('Water', 'Glycerol'),
                    k=1.1,
                    P=101325,
                    y_top=0.999,
...
H403 = HXutility('H403', V=0, T=315)
P411 = Pump('P411')

# Condense recycle water
H404 = HXutility('H404', V=0, T=315)
P412 = Pump('P412')
...
def adjust_water_flow():
    total_glycerol =  (C401.outs[1].mol[2] + R402.outs[0].mol[2])
    biodiesel_wash_water.mol[4] = (x_water / (1 - x_water) * total_glycerol
                                   - HCl1.mol[4] - NaOH.mol[4] - oil.mol[4]
                                   - HCl2.mol[4])
    
def remove_accumulation():
    D402.outs[0].mol[4] = 1100*C402.outs[0]._mol[2]
...
D402.outs[0].mol[:] = H404.outs[0].mol[:] = [0.000e+00, 1.413e-03,
                                             1.514e-03, 0.000e+00, 
                                             1.513e+00, 0.000e+00,
                                             0.000e+00, 0.000e+00]
