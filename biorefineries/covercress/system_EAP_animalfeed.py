...
# -*- coding: utf-8 -*-
"""
Created on Mon Sep  7 13:37:14 2026
...
@SystemFactory(
    ...
    outs=[
       ...
       dict(ID='meal', units='kg/hr', price=price['meal']),  # animal feed
...
def create_covercress_oil_sys(ins,outs,moisture_content=0.03):# maxmium oil recovery obtained when the cooked seeds was at 3 %
    ...
    SAF,meal,naphtha_product, green_diesel, propane = outs
    ...
    T_meal = bst.StorageTank('T_meal', ins=H103-0, outs=meal)
...
feedstock = feed
SAF = s.SAF
meal = s.meal          # or u.H103.outs[0] / u.T_meal.outs[0]
# must be BEFORE set_market_prices()
...
covercress_LCA = CovercressLCA(
    ...
    by_products=[ naphtha_product, green_diesel, propane],
    boiler=BT,
    cooling_tower=CT,
