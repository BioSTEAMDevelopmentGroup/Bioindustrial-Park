...
def run_TRY_analysis(feedstock, neutralization, yields=None, titers=None, productivities=None, return_YT_arrays=False, plot=False, steps_for_default_YT=50):
    ...
    parameter_distributions_filename = succinic_filepath+'\\analyses\\parameter_distributions\\'+filename
    model.parameters = ()
    ...
    if not productivities:
        productivities = [spec.baseline_productivity]
    ...
    if return_YT_arrays:
        inflection_product_yields = np.array([1.-spec.baseline_cell_mass_yield-spec.baseline_pyruvic_acid_yield])
        return yields, titers, inflection_product_yields, results_metric_1, results_metric_2, results_metric_3, results_metric_4
    else:
        return results_metric_1, results_metric_2, results_metric_3, results_metric_4
