...
setup(
    ...
    url='https://github.com/yoelcortes/Bioindustrial-Park/tree/master/biorefineries/BioSTEAM 1.x.x/biorefineries',
    download_url='https://github.com/yoelcortes/Bioindustrial-Park/tree/master/biorefineries/BioSTEAM 1.x.x/biorefineries',
